...
func (t *tx) Update(table string, set map[string]interface{}, where q.Stmt) (sql.Result, error) {
	return t.s.Update(table, set, where)
}

func (t *tx) UpdateModel(ptr interface{}, where q.Stmt) (sql.Result, error) {
	return t.s.UpdateModel(ptr, where)
}

func (t *tx) UpdateContext(ctx context.Context, table string, set map[string]interface{}, where q.Stmt) (sql.Result, error) {
	return t.s.UpdateContext(ctx, table, set, where)
}

func (t *tx) UpdateModelContext(ctx context.Context, ptr interface{}, where q.Stmt) (sql.Result, error) {
	return t.s.UpdateModelContext(ctx, ptr, where)
}

func (t *tx) Delete(table string, where q.Stmt) (sql.Result, error) {
	return t.s.Delete(table, where)
}

func (t *tx) DeleteContext(ctx context.Context, table string, where q.Stmt) (sql.Result, error) {
